...
description: "Define the minimum operational diagnostics and triage path for the 4-hour BuildAThon MVP."
...
Your job is to define how the MVP would be diagnosed if it failed during demo or in a simple production-like scenario.
...
- Identify likely failure modes in the MVP
...
- Assume the MVP is small and time-boxed
